...
<body class="gray-bg">
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form id="picImageForm" method="post" action="${pageContext.request.contextPath}/emp/updatePicImage" enctype="multipart/form-data" class="form-horizontal">
                    	   <div class="row">
                    	   		<div class="col-sm-4 col-sm-offset-1 logoshow">
                                 <img id="pic" src="${activeUser.pic}" />
                            </div>
                    	   </div>
                       <div class="row">
                            <div class="form-group">
                                <div class="col-sm-4 col-sm-offset-1">
                                    <input name="picImage" type="file" class="form-control" >
                                </div>
                            </div>
                        </div>
                        <div class="row">
                         ...
                         <div class="row">
                            <div class="form-group">
                                <div class="col-sm-3 col-sm-offset-3 text-right">
                                    <button type="button" class="btn btn-primary" onclick="changeImage();">保存内容</button>
                                </div>
                                <div class="col-sm-3">
   ...
   <script>
	    function changeImage(){
	        ...
	        $("#picImageForm").ajaxForm();
            ; $("#picImageForm").ajaxSubmit(function(rs){
                if(rs.status==200){
