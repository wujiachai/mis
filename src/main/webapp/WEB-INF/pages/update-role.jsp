    ...
    <script>
                    ...
                    var setting = {
                        ...
                        callback:{
                            onAsyncSuccess: function zTreeOnAsyncSuccess(event, treeId, treeNode, msg) {
                                ...
                                $(rs.sourceIds).each(function(index,item){
                                    //获取我们要进行勾选的节点
                                    var node = var_zTree.getNodeByParam("id",item,null);
                                    if(node != null) {
        ...
        function updateRole(){
            ...
            $.ajax({
                ...
                type:"post",
                data:{"roleid":${roleid},"rolename":rolename,"roledis":roledis,"status":status,"ids":ids},
                dataType:"json",
                cache:false,
                success:function(rs){
                    if(rs.status==200){
