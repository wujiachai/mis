...
<body class="gray-bg">
			...
			<div class="col-sm">
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						<form id="sorucesForm" class="form-horizontal">
							...
							<div class="form-group">
								<div class="col-sm-offset-3 col-sm-4">
									<input type="button" value="更新" onclick="updateSources();"/>
	...
	<script>
		$(function(){
		    ...
		    $.ajax({
                url:"${pageContext.request.contextPath}/sources/getSourceById",
                type:"post",
                data:{"id":${id}},
                dataType:"json",
                cache:false,
		...
		function updateSources(){
		    $.ajax({
				url:"${pageContext.request.contextPath}/sources/updateSources",
				type:"post",
				data:$("#sorucesForm").serialize(),
				dataType:"json",
				cache:false,
				success:function (rs) {
					if(rs.status==200){
                        swal({
                            ...
                            window.location="${pageContext.request.contextPath}/sources/list-resources";
						});
