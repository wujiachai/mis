                ...
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element mylogo">
                            ...
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                               ...
                               <span class="text-muted text-xs block">${activeUser.roleName}<b class="caret"></b></span>
                               </span>
                            </a>
                            <ul class="dropdown-menu animated fadeInRight m-t-xs">
                                <li><a class="J_menuItem" href="${pageContext.request.contextPath}/main/update-picImage">修改头像</a>
                                </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a class="J_menuItem" href="${pageContext.request.contextPath}/sources/list-resources" data-index="0">菜单资源管理</a>
                            </li>
                        </ul>
